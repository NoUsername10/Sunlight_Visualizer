...
It  displays roof and wall sunlight intensity, shadows, and optional solar power (or any power sensor you select), in a single HACS install.
...
[Watch the video](assets/rotation.mp4)
